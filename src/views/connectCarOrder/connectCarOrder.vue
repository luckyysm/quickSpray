<template>
  <div class="app-container calendar-list-container">
    <filterContainer>
      <form-item>
        <el-select v-model="formInline.region" placeholder="下单日期" style="width: 120px">
      ...
      <!--渠道单号-->
      <form-item>
        <el-select v-model="formInline.region" placeholder="取送车单号" style="width: 120px">
    ...
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      ...
      <el-tab-pane label="待取车" name="second"></el-tab-pane>
      <el-tab-pane label="送车中" name="third"></el-tab-pane>
      <el-tab-pane label="已送达" name="four"></el-tab-pane>
